# Pre - entrega 3 - Coder House - Python
...
En el pie del sitio se encuentran mis redes sociales, solamente para complementar.

# Objetivos

1. Herencia HTML (cada sitio redireccionado cuenta con herencia Template)
2. Por lo menos 3 clases en models (El proyecto cuenta con 4 clases)
3. Un formulario para insertar datos a todas las clases de los models (Todos mis models cuentan con un formulario)
4. ReadMe (Mi proyecto cuenta con un "README" lo mas completo posible)